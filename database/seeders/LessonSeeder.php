...
class LessonSeeder extends Seeder
{
    public function run(): void
    {
        ...
        if ($logicCourse) {
            ...
            // Tahap 1: Array, Fungsi, Argumen
            $this->createLogicLesson6($logicCourse);
            $this->createLogicLesson7($logicCourse);
            $this->createLogicLesson8($logicCourse);
            
            // Tahap 2: Scope, Debugging, Stack/Queue
            $this->createLogicLesson9($logicCourse);
            $this->createLogicLesson10($logicCourse);
            $this->createLogicLesson11($logicCourse);
            
            // Tahap 3: Pencarian, Pengurutan, Rekursi
            $this->createLogicLesson12($logicCourse);
            $this->createLogicLesson13($logicCourse);
            $this->createLogicLesson14($logicCourse);
            
            // Tahap 4: Pemrograman Modular
            $this->createLogicLesson15($logicCourse);
        }
    ...
    private function createLogicLesson6($course)
    {
        $lesson = Lesson::firstOrCreate(
            ...
            [
                ...
                'content' => 'Menyimpan antrean data dalam satu variabel.', 'video_url' => null, 'order' => 6, 'xp_reward' => 45,
            ]);
    ...
    private function createLogicLesson7($course)
    {
        $lesson = Lesson::firstOrCreate(
            ...
            [
                ...
                'content' => 'Blok kode yang bisa digunakan berulang kali.', 'video_url' => null, 'order' => 7, 'xp_reward' => 50,
            ]);
        ...
        // 7. Trivia
        $lesson->slides()->firstOrCreate(['order' => 7], ['type' => 'text', 'title' => 'Cara Membuat', 'content' => "Di banyak bahasa (seperti Python), fungsi dibuat dengan kata kunci `def` atau `function`.\nContoh:\n`def sapa():`\n  `PRINT \"Halo Semuanya!\"`"]);
        // 8. Quiz (3 pilihan)
    ...
    private function createLogicLesson8($course)
    {
        $lesson = Lesson::firstOrCreate(
            ...
            [
                ...
                'content' => 'Fungsi yang cerdas dan interaktif.', 'video_url' => null, 'order' => 8, 'xp_reward' => 55,
            ]);
    ...
    private function createLogicLesson9($course)
    {
        $lesson = Lesson::firstOrCreate(
            ...
            [
                ...
                'content' => 'Di mana variabelmu hidup dan mati.', 'video_url' => null, 'order' => 9, 'xp_reward' => 50,
            ]);
        ...
        // 9. Trivia
        $lesson->slides()->firstOrCreate(['order' => 9], ['type' => 'text', 'title' => 'Bahaya Variabel Global', 'content' => "Walau praktis, memakai terlalu banyak variabel global itu bahaya!\nKarena SEMUA fungsi bisa mengubah isinya secara bebas, melacak siapa yang secara tak sengaja \'merusak\' data menjadi sangat sulit."]);
        // 10. Quiz (3 pilihan)
    ...
    private function createLogicLesson10($course)
    {
        $lesson = Lesson::firstOrCreate(
            ...
            [
                ...
                'content' => 'Sebagai detektif kode yang ulung.', 'video_url' => null, 'order' => 10, 'xp_reward' => 50,
            ]);
    ...
    private function createLogicLesson11($course)
    {
        $lesson = Lesson::firstOrCreate(
            ...
            [
                ...
                'content' => 'Tumpukan piring dan antrean kasir.', 'video_url' => null, 'order' => 11, 'xp_reward' => 50,
            ]);
        ...
        // 11. Trivia
        $lesson->slides()->firstOrCreate(['order' => 11], ['type' => 'text', 'title' => 'Operasi Utama', 'content' => "Istilah untuk menambah data di *Stack* adalah **Push**, untuk mengambil data namanya **Pop**.\nUntuk menambah data di *Queue* adalah **Enqueue**, lalu mengambil data **Dequeue**."]);
        // 12. Quiz (3 pilihan)
    ...
    private function createLogicLesson12($course)
    {
        $lesson = Lesson::firstOrCreate(
            ...
            [
                ...
                'content' => 'Menemukan jarum dalam tumpukan jerami.', 'video_url' => null, 'order' => 12, 'xp_reward' => 50,
            ]);
    ...
    private function createLogicLesson13($course)
    {
        $lesson = Lesson::firstOrCreate(
            ...
            [
                ...
                'content' => 'Merapikan data yang berantakan.', 'video_url' => null, 'order' => 13, 'xp_reward' => 50,
            ]);
        ...
        // 13. Trivia
        $lesson->slides()->firstOrCreate(['order' => 13], ['type' => 'text', 'title' => 'Built-In Sort', 'content' => "Beruntunglah kamu lahir zaman sekarang. Di bahasa pemrograman moderen misal Python, kamu cukup panggil `buah.sort()` dan boom! langsung terurut ke A-Z otomatis."]);
        // 14. Quiz (3 pilihan)
    ...
    private function createLogicLesson14($course)
    {
        $lesson = Lesson::firstOrCreate(
            ...
            [
                ...
                'content' => 'Fungsi yang memanggil dirinya sendiri.', 'video_url' => null, 'order' => 14, 'xp_reward' => 55,
            ]);
    ...
    private function createLogicLesson15($course)
    {
        $lesson = Lesson::firstOrCreate(
            ...
            [
                ...
                'content' => 'Membangun aplikasi seperti menyusun balok Lego.', 'video_url' => null, 'order' => 15, 'xp_reward' => 55,
            ]);
